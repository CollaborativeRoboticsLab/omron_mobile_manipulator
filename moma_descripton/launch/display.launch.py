...
def generate_launch_description():
    #robot_description_config = load_file('moma_descripton', 'urdf/AMR_Platform.urdf')
    # robot_description_config = load_file('moma_descripton', 'urdf/LD90.urdf')
    robot_description_config = load_file('moma_descripton', 'urdf/LD250.urdf')
    robot_description = {'robot_description' : robot_description_config}

    vis_config = get_package_share_directory('moma_descripton') + "/param/vis_param.yaml"

    # RViz
    rviz_config_file = "src/moma_descripton/config/amr_rviz.rviz"
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        output='log',
